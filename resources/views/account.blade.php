            ...
            <div class="flex gap-x-4">
                ...
                <form action="/process_user_update/{{$userdetail->id}}}" id="myForm" method="POST" class="flex flex-col w-1/2 p-5">
                    ...
                    <div class="flex w-4/2">
                        <input type="password" name="password" value="" class="w-full border border-slate-300 rounded-xl py-2 pl-4 pr-10 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm">
                    ...
                    <label class="mb-2 mt-2 text-sm font-regular text-gray-500">Confirm Password</label>
                    <div class="flex w-4/2">
                        <input type="password" name="password_confirmation" value="" class="w-full border rounded-xl py-2 pl-4 pr-10 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm">
                        <span id="toggleConfirmPassword" class="mt-3 ml-3 cursor-pointer">
                            <span class="material-symbols-outlined">visibility</span>
                        </span>
                    </div>
                    @error('password_confirmation')
